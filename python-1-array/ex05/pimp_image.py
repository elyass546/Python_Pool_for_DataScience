...
def ft_red(array: np.array) -> np.array:
    """
        Applies a red filter by setting only
        the red channel and removing others.
    """
...
def ft_green(array: np.array) -> np.array:
    """
        Applies a green filter by setting only
        the green channel and removing others.
    """
...
def ft_blue(array: np.array) -> np.array:
    """
        Applies a blue filter by setting only
        the blue channel and removing others.
    """
...
def ft_grey(array: np.array) -> np.array:
    ...
    grey_array = array.mean(axis=2).astype(np.uint8)
    # Stack to keep RGB format
