...
def main():
    ...
    if life_expectancy_years is not None and income_per_person is not None:
        project_Life_Expectancy_GNP_1900(life_expectancy_years, income_per_person)

#displays the projection of life expectancy in relation to the gross national product of
